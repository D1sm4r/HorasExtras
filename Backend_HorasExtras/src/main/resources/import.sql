...
insert into empleado (id, nombre_usuario, password, id_cargo, id_admin) values (1, 'Seba', 'FDS3342', 1, 1);

insert into supervisor (id_supervisor, nombre_ususario, password, id_admin) values (1, 'Hernan', 'ds231dW', 1);
